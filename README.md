...
<div align="center">
  ...
  <p align="center">
    PlexMeet as per it's name it is a video conferencing application which is built using Next.js, WebRTC, and Socket.IO.
    <br />
    <a href="https://github.com/Harshjs-Gupta/PlexMeet2">View Demo</a>
  </p>
</div>
...
1. Clone the repo
   ```sh
   git clone https://github.com/Harshjs-Gupta/PlexMeet2
   ```
...
[product-screenshot]: /plexmeetcall/public/PlexMeet.gif
